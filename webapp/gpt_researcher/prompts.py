...
If the task asks for latest, current, recent, or uses rolling time windows like last 7 days, last 30 days, last 90 days, or last 12 months, keep the queries anchored to that current date.
Do not replace a rolling time window with an older fixed year unless the task explicitly asks for a historical year or period.
