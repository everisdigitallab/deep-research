...
INSERT OR IGNORE INTO exchange_rates (id, currency_code, rate_to_eur, rate_date, created_by, created_at) VALUES
('ex-eur-1', 'EUR', 1.0, '2026-08-01', 'u-master-001', datetime('now')),
('ex-brl-1', 'BRL', 0.17, '2026-08-01', 'u-master-001', datetime('now')),
('ex-usd-1', 'USD', 0.92, '2026-08-01', 'u-master-001', datetime('now'));
